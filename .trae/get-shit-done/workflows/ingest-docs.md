...
```bash
INIT=$(node "C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.trae/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.trae/get-shit-done/bin/gsd-tools.cjs" commit \
