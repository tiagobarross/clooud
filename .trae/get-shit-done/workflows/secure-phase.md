...
```
Agent(
  prompt="Read C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.trae/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.trae/get-shit-done/templates/SECURITY.md`
