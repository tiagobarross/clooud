...
The keys live in `.trae/settings.json` (project) or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.trae/settings.json` (global) — **not** in `.planning/config.json`:
