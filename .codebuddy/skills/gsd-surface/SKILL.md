...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/.gsd-surface.json`
(sibling to `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/skills/gsd-*/`.
...
(`C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy`), NOT the skills sub-directory (`C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy` as `configDir`. The skill dirs themselves live at
`C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# CodeBuddy — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy}"
SCOPE="global"
...
(i.e. `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/.gsd-surface.json`
Install profile marker: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/.gsd-profile`
Skill dirs: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/skills/gsd-*/`
Engine module: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codebuddy/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
