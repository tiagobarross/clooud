...
The keys live in `.codex/settings.json` (project) or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.codex/settings.json` (global) — **not** in `.planning/config.json`:
