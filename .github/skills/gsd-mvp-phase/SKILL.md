...
<execution_context>
@~/.copilot/get-shit-done/workflows/mvp-phase.md
@~/.copilot/get-shit-done/references/spidr-splitting.md
@~/.copilot/get-shit-done/references/user-story-template.md
</execution_context>
...
<process>
Execute the mvp-phase workflow from @~/.copilot/get-shit-done/workflows/mvp-phase.md end-to-end.
