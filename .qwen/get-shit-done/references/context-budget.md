...
The keys live in `.qwen/settings.json` (project) or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.qwen/settings.json` (global) — **not** in `.planning/config.json`:
