...
<required_reading>
@C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/get-shit-done/references/ai-frameworks.md
@C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/agents/gsd-eval-planner.md for instructions.
