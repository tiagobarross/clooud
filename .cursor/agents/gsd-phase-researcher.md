...
@C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
