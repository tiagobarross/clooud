...
The keys live in `.cline/settings.json` (project) or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/settings.json` (global) — **not** in `.planning/config.json`:
