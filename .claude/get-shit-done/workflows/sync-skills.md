...
INSTALL_JS_GLOBAL="C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
