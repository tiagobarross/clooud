...
**If doesn't exist:** Create from template at `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.claude/get-shit-done/templates/retrospective.md`.
