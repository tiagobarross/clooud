...
- **Global scope**: `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/notes/`)
...
2. Glob `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/notes/` — works in any directory
