...
The keys live in `.claude/settings.json` (project) or `C:/Users/tiago/OneDrive/Área de Trabalho/geral/Estudos DEV/clooud/.kilo/settings.json` (global) — **not** in `.planning/config.json`:
